    ...
    <table class="table text-white">
      ...
      <tbody>
        ...
        while ($dado = mysqli_fetch_assoc($result)) {
          //Converte Data e Horario para o formato BR
          $data_horario = date("d/m/Y H:i",strtotime($dado['Data_Horario']));
          //Formatar Telefone utilizando substr
          $telefone ="Não cadastrado";
          if(!empty($dado['Telefone'])){

            $ddd = substr($dado['Telefone'],0,2);
            $parte1 = substr($dado['Telefone'],2, 5);
            $parte2 = substr($dado['Telefone'], 7);
            $telefone = "($ddd) $parte1-$parte2";
          }
          // $Cpf ="";
          // if(!empty($dado['Cpf'])){

          //   $posicao1 = substr($dado['Cpf'],0,3);
          //   $posicao2 = substr($dado['Cpf'],3, 3);
          //   $posicao3 = substr($dado['Cpf'],3, 3);
          //   $posicao4 = substr($dado['Cpf'],2);
          //   $Cpf = "$posicao1.$posicao2.$posicao3-$posicao4";
          // }
          ...
          echo "<td>" .$data_horario. "</td>";
          // echo "<td>" . $dado['Marcado'] . "</td>";
          echo "<td> 
