        ...
        <form action="saveEdit.php" method="POST">
            <fieldset>
                ...
                <input type="radio"id="feminino"nome="genero" value="feminino" <?= ($sexo =='F') ? 'checked' : ''?>required>
                 ...
                 <label for="Tipo de servico" class="labelInput">Tipo de serviço:</label>
                    <select  <?= $Tipo_Servico;?>  name="Tipo_Servico" > 
                    <option value="Social">Social</option>
                    <option value="Social">Degrade</option>
                    <option value="Social">Social</option>
                  </select>
                ...
                <br><br>
                 ...
                 <button type="submit" name="update"id="submit">Salvar</button>
                </fieldset>
        </form>
    </div>
</body>
